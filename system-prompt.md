...
- When serching for code, use `code_search` tool.
- When serching for similar pattern of code, use `code_search_relate` tool.
- Both have ability to search remote git repository.
